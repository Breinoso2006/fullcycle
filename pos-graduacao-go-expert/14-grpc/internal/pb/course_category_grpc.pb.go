...
const (
	...
	CategoryService_CreateCategoryBidirectionalStream_FullMethodName = "/pb.CategoryService/CreateCategoryBidirectionalStream"
...
type CategoryServiceClient interface {
	...
	CreateCategoryBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error)
...
func (c *categoryServiceClient) CreateCategoryBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], CategoryService_CreateCategoryBidirectionalStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryBidirectionalStreamClient = grpc.BidiStreamingClient[CreateCategoryRequest, Category]
...
type CategoryServiceServer interface {
	...
	CreateCategoryBidirectionalStream(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryBidirectionalStream(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error {
...
func _CategoryService_CreateCategoryBidirectionalStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryBidirectionalStream(&grpc.GenericServerStream[CreateCategoryRequest, Category]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryBidirectionalStreamServer = grpc.BidiStreamingServer[CreateCategoryRequest, Category]
