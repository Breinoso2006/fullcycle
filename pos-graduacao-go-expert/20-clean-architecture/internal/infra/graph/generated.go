...
func (ec *executionContext) field_Mutation_createOrder_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalOOrderInput2ᚖgithubᚗcomᚋbreinoso2006ᚋfullcycleᚋposᚑgraduacaoᚑgoᚑexpertᚋ20ᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOOrder2ᚖgithubᚗcomᚋbreinoso2006ᚋfullcycleᚋposᚑgraduacaoᚑgoᚑexpertᚋ20ᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋbreinoso2006ᚋfullcycleᚋposᚑgraduacaoᚑgoᚑexpertᚋ20ᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOOrderInput2ᚖgithubᚗcomᚋbreinoso2006ᚋfullcycleᚋposᚑgraduacaoᚑgoᚑexpertᚋ20ᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v any) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
